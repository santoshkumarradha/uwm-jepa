...
planning, and not for any claim that recurrent or Transformer
predictors with different architectures or objectives could not close
the gap. The counterfactual training target also requires simulator
access to construct alternate futures, which limits portability to
settings where only passive videos or observation streams are
available.
