...
as actions are perturbed; the parameter-matched LSTM-JEPA-CF
configuration tested under the same objective and action head
collapses to majority-class accuracy ($0.53$) under every action
condition. Under blind rollout, UWM-JEPA
...
matter, not frozen context-encoding capacity alone.
\end{abstract}
